...
static const double GRIPPER_REFERENCE_GEAR_RADIUS_DEFAULT_M = 0.00853;
static const double GRIPPER_REFERENCE_GEAR_RADIUS_LEFT_M = 0.03899970;
static const double GRIPPER_REFERENCE_GEAR_RADIUS_RIGHT_M = 0.03527805;
static const double GRIPPER_GEAR_DIRECTION_MULTIPLIER = 1.0;
static const double GRIPPER_ENDPOINT_PRELOAD_RAD = 0.60;
static const double GRIPPER_ENDPOINT_THRESHOLD_M = 0.001;
static const double GRIPPER_MAX_OPENING_M = 0.044;
...
class OpenArmHW : public hardware_interface::SystemInterface {
 ...
 private:
  std::string prefix_;
  double gripper_reference_gear_radius_m_ =
      GRIPPER_REFERENCE_GEAR_RADIUS_DEFAULT_M;
